...
<template>
    <section class="max-container flex justify-between items-center max-lg:flex-col gap-10">
        <h3 class="text-4xl leading-[68px] lg:max-w-md font-palanquin font-bold">Sign Up fot <span class="text-coral-red">Updates</span> & Newsletter</h3>
